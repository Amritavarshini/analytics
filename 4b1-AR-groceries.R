...
rules
inspect (rules[1:5])
#people who purchased baking powder, also purchased whole milk, indicated with 52% confidence, transaction repeated 91 times, and that is 0.9% of total purchases.
# lift is the measure of the strtength of association btw lhs and rhs
# it is confidence by probability of rhs
